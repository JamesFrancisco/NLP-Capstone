# =================================================
# : John Hopkins University / Coursera.org
# : Data Science Specialization - Capstone Project
# : April 2019
# :
# : Shiny Application: NLP Next Word Prediction
# :
# : James Francisco PhD
# :
# =================================================
...
ui <- fluidPage(
	# Application title
  	titlePanel("Data Science Capstone Project - NLP Next Word Prediction App"),
  ...
  # User interface controls1
	...
	fluidRow(HTML("<div style='margin-left:18px;margin-bottom:12px;color:navy;'><strong>(c)2019 James R. Francisco PhD</strong><div>") )
